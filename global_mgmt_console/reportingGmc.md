...
Currently, five built-in reports are available from the Backup and Recovery Manager for {{site.data.keyword.baas_full}}.
...
Reporting from the Backup and Recovery Manager for {{site.data.keyword.baas_full_notm}} provides a comprehensive view of the data.
Each report type helps you view, visualize, and analyze data. The following table describes the key features of the Backup and Recovery Manager reports:
...
Each report type from the Backup and Recovery Manager for {{site.data.keyword.baas_full_notm}} provides comprehensive data. In each report type, data is displayed in a tabular format. You can add and remove columns from the Data table. The changes that you make to columns in a table persist until you change them again or until you restore the report to the default view.
...
Download reports in different file formats from the Backup and Recovery Manager reports page.
...
To switch to the default from the Backup and Recovery Manager for {{site.data.keyword.baas_full_notm}} reports page view, click Restore to default display icon. The page refreshes and reverts to the default view.
