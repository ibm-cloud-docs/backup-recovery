...
| Source | Destination | Destination Port | Protocol | Usage Notes | Type of Traffic |
| --- | --- | --- | --- | --- | --- |
| {{site.data.keyword.baas_full}} | Pure Storage | 3260, 3205 | TCP | iSCSI port for Pure Storage. | Backup and Recovery |
| {{site.data.keyword.baas_full}} | IBM Storage FlashSystem | 3260, 7443 | TCP | 3260 port for iSCSI<br><br>7443 port for API | Backup and Recovery |
{: caption="" caption-side="bottom"}
...
| Source | Destination | Destination Port | Protocol | Usage Notes | Type of Traffic |
| --- | --- | --- | --- | --- | --- |
| Client | {{site.data.keyword.baas_full}} | 53  | TCP/UDP | Serve DNS requests from an external source. | Management |
...
| Source | Destination | Destination Port | Protocol | Usage Notes |
| --- | --- | --- | --- | --- |
| {{site.data.keyword.baas_full_notm}} | helios-data2.ibm.com | 443 | TCP | Heartbeats and telemetry from DataHawk app to {{site.data.keyword.baas_full}} Helios. |
| {{site.data.keyword.baas_full_notm}} | helios-dc3p.ibm.com | Classification heartbeats, telemetry, results from DataHawk app to {{site.data.keyword.baas_full}} Helios. |
{: caption="" caption-side="bottom"}
...
| Source | Destination | Destination Port | Protocol | Usage Notes | Type of Traffic |
| --- | --- | --- | --- | --- | --- |
| HTTP client | {{site.data.keyword.baas_full_notm}} | 61001 through 63786 | TCP | Used for {{site.data.keyword.baas_full}} MarketPlace Apps, which are available from the MarketPlace and Helios. One port is dynamically assigned from this range for the user interface of each app instance. | Management |
{: caption="" caption-side="bottom"}
...
| {{site.data.keyword.baas_full_notm}} | Remote {{site.data.keyword.baas_full_notm}} (target or receiving) | 20000 | TCP | *   Required for replication.<br>    <br>*   Required for interaction handling between {{site.data.keyword.baas_full}} and target backup systems. |
{: caption="" caption-side="bottom"}
