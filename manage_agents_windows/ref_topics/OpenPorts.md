...
You must open certain ports in the firewall to allow the {{site.data.keyword.baas_full}} to transmit and receive data. The cluster sends the following types of traffic over the network. You can isolate traffic on physical or logical networks to improve performance and security.
